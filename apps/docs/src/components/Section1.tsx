...
export const Section1 = () => {
  return (
    <div className="flex flex-col items-center justify-center base:mt-[64px] md:mt-[80px] overflow-x-hidden overflow-y-hidden">
      <Tilt
        scale={1}
        tiltMaxAngleX={25}
        tiltMaxAngleY={25}
      ...
      >
        <div
          className="relative w-fit flex flex-col items-center justify-center mx-auto transform-3d perspective-1000"
          style={{
            transformStyle: 'preserve-3d',
          }}
        >
          ...
          <div className="absolute base:top-[36.5px] md:top-[99px] base:-left-[98px] md:left-0 md:-translate-x-[50%] cursor-pointer z-10 hover:z-30 transform-3d translate-z-[0px]">
