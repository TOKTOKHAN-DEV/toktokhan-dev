    ...
    <div>
      <div
        ...
        className={cn([
          ...
          'w-full md:min-h-[400px] md:py-[80px] px-[40px] base:pt-[160px] base:pb-[80px] md:mt-[240px]',
          'base:bg-transparent base:max-w-[404px] base:mx-auto md:max-w-[100vw]',
      ...
      >
        ...
        {isHovered && (
          <div
            className={cn([
              'absolute inset-0 flex will-change-transform base:hidden md:flex',
        ...
        <div
          className={cn([
            ...
            'base:text-content-1',
            isHovered ? 'md:text-content-8' : 'md:text-content-2',
          ])}
        >
  ...
  return (
    <a
      ...
      className={cn([
        ...
        'px-6 py-3 rounded-full border-none bg-content-8',
        'typo-uncut-heading-01 whitespace-nowrap cursor-none no-underline hover:no-underline pointer-events-auto',
        className,
      ])}
      rel="noreferrer"
    >
      <HandPeaceIcon className="size-6" />
...
const FloatingButtonPortal = ({
  ...
  const colorClass = {
    'accent-brewin-blue':
      'text-accent-brewin-blue hover:text-accent-brewin-blue',
    'accent-brewin-yellow':
      'text-accent-brewin-yellow hover:text-accent-brewin-yellow',
    'accent-brewin-red': 'text-accent-brewin-red hover:text-accent-brewin-red',
    'accent-brewin-green':
      'text-accent-brewin-green hover:text-accent-brewin-green',
  }[currentColor]
